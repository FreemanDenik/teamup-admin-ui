...
// TODO получить данные с сервера (когда заработает)
  ...
  return [
    ...
    timeEvent: "22.02.2022 с 10:00 до 22:00",
    eventPrivacy: false,
    ...
    placeEvent: "ВДНХ",
    city: "Москва",
    timeEvent: "20.02.2022 с 10:00 до 22:00",
    eventPrivacy: false,
    ...
    city: "Казань",
    timeEvent: "25.02.2022 с 10:00 до 22:00",
    eventPrivacy: false,
    ...
    city: "Омск",
    timeEvent: "01.04.2022 с 10:00 до 22:00",
    eventPrivacy: false,
    participantsCount: 500,
    eventType: {
      id:0,
    ...
    city: "Владивосток",
    timeEvent: "25.03.2022 с 10:00 до 22:00",
    eventPrivacy: false,
    participantsCount: 500,
    eventType: {
      id:0,
